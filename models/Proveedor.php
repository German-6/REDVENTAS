<?php
    class Proveedor extends Conectar{
        ...
        /* TODO: Registro Datos */
        public function insert_proveedor($emp_id,$prov_nom,$prov_rut,$prov_telf,$prov_direcc,$prov_correo){
            $conectar=parent::Conexion();
            $sql="SP_I_PROVEEDOR_01 ?,?,?,?,?,?";
            $query=$conectar->prepare($sql);
            $query->bindValue(1,$emp_id);
            $query->bindValue(2,$prov_nom);
            $query->bindValue(3,$prov_rut);
        ...
        public function update_proveedor($prov_id,$emp_id,$prov_nom,$prov_rut,$prov_telf,$prov_direcc,$prov_correo){
            $conectar=parent::Conexion();
