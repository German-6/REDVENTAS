...
BEGIN
	...
	(SUC_ID,USU_CORREO,USU_NOM,USU_APE,USU_CC,USU_TELF,USU_PASS,ROL_ID,FECH_CREA,EST)
	VALUES
	(@SUC_ID,@USU_CORREO,@USU_NOM,@USU_APE,@USU_CC,@USU_TELF,@USU_PASS,@ROL_ID,GETDATE(),1)
END
